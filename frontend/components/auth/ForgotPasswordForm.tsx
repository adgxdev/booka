export default function ForgotPasswordForm() {
    return (
        <div className="w-11/12 max-w-md flex flex-col gap-y-5">
            <form>
                <input type="email" placeholder="Email or Phone number" className="w-full bg-white text-black placeholder-black rounded-lg py-2.5 px-3 mt-4 focus:outline-none" />
