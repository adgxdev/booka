...
//         e.preventDefault();
//         console.log("Submit all data here...");
//     };
...
//                         <h1 className="text-2xl bold-text text-[#00C6FF]">Welcome back! <br/>Sign Up to continue</h1> 
//                     </div>
...
//                         <Image src='/icons/google.png' alt="google icon" className="h-7 w-7" height={100} width={100} /><span>Sign Up with Google</span>
//                     </button>
//                     <div className="text-center flex justify-center items-center">Or</div>
//                     <form onSubmit={handleNext}>
//                         <input type="text" placeholder="Username" className="w-full bg-white text-black placeholder-black rounded-lg py-4 px-3 focus:outline-none" />
...
//                         <button type="submit" className="w-full bg-linear-to-r from-[#1A73E8] to-[#00C6FF] text-sm rounded-lg py-4 px-3 text-white mt-6">Next</button>
//                     </form>
//                     <div className="mt-6 space-y-8 flex flex-col items-center text-center">
//                         <p className="w-9/12 text-center text-sm">
//                             By signing you are agreed with <br/>our friendly terms and condition
//                         </p>
...
//                         <h1 className="text-2xl bold-text text-[#00C6FF]">Other Information</h1> 
//                     </div>
//                     <form onSubmit={handleFinalSubmit}>
//                         <select className="w-full bg-white text-black placeholder-black rounded-lg py-4 px-3 focus:outline-none">
//                             <option>Select University</option>
//                             <option>UNN</option>
//                             <option>UNEC</option>
//                         </select>
//                         <select className="w-full bg-white text-black placeholder-black rounded-lg py-4 px-3 mt-4 focus:outline-none">
