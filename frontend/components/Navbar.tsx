    ...
    return (
        <nav className="z-50 w-full fixed top-0 text-black backdrop:blur-sm flex justify-between items-center px-4 py-6">
            <div className="w-11/12 mx-auto flex justify-between items-center">
                ...
                <div className="">
                    <Link href="/about" className="bg-black text-white rounded-lg py-2.5 px-3 text-sm flex gap-2 items-center justify-center font-bold hover:scale-102 duration-500">
