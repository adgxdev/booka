...
//     return (
//         <main className="bg-[#0A192F] text-white w-full px-4 py-30 md:py-30 min-h-screen overflow-x-hidden">
//             <Navbar />
//             <div className="w-full md:w-9/12 lg:w-9/12 2xl:w-7/12 mx-auto text-center">
...
//                         <input type="text" value={`🚀 Join me and get early access to Booka — the easiest way to get your books online! 📚 Use my referral code: ${waitlistData?.referralCode ?? ""} Join here: https://www.bookacampus.com`} readOnly className="bg-gray-100 text-black w-9/12 border border-[#3a3737] outline-none rounded-lg py-2 ps-3 pe-2" name="email" placeholder="Enter your email address" />
